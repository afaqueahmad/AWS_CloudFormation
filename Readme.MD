In this lab we are going to prvision/deploy 2-tier architecture(Highly available and scalable) complete infrastructre On AWS in one go using CloudFormation template.
